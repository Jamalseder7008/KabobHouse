...
export const {Context, Provider} = createDataContext(saladReducer, {loadSalads:loadSalads}, [
    ...
    {id: 134, title: "Tabouli",      description: "fine chopped parsley, cracked wheat, tomatoes, and cucumber dressed with lemon salt and olive oil dressing", imageSource: require('../../assets/KabobHouseLogo.jpg'), price: 8},
    ...
    {id: 136, title: "Lentil Soup Cup", description: "Flavorful lentil, carrot, and onion pureed soup(Cup 8oz)", imageSource: require('../../assets/KabobHouseLogo.jpg'),price: 5},
    {id: 137, title: "Lentil Soup Bowl", description: "Flavorful lentil, carrot, and onion pureed soup(Bowl 12oz)", imageSource: require('../../assets/KabobHouseLogo.jpg'), price: 7}
]);